...
# Агрегация, обогащение с помощью LLM,  
фильтрация и визуализация данных  
о продуктах питания онлайн-магазинов  
...
- **Основные трудности:**  
  ...
  - **Ограниченный поиск:** нет фильтрации по сложным нутриентным критериям (`белок / калории`).  
  - **Скрытые характеристики:** сложно проверить кето-совместимость, лактозу и др.  
  - **Громоздкость:** множество сайтов, медленная загрузка страниц.  
- **Проблема:** отсутствует единый инструмент, автоматизирующий сбор, обогащение и анализ данных.
...
- **Цель:** разработать комплекс, который  
  ...
  - обогащает их нутриентной и диетологической информацией,  
...
- **Фишка:** пользовательские формулы сортировки  
  - Пример: `protein / calories * 100` → «самые белковые».
...
- **Технические достижения:**  
  ...
  4. Экспорт в Google Sheets + шаблон планировщика.  
